...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        //Get the shared prefs for mid and treble


        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.show_mid_key),
    ...
    private void loadColorFromPreferences(SharedPreferences preferences) {
        mVisualizerView.setColor(preferences.getString(getString(R.string.colors_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(key,
                    getResources().getBoolean(R.bool.pref_show_bass_default)));
        } else if (key.equals(getString(R.string.show_mid_key))) {
        ...
        else if (key.equals(getString(R.string.colors_key))){
            loadColorFromPreferences(sharedPreferences);
        }
    }
